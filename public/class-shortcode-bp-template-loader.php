...
if ( ! class_exists( 'Shortcode_BP_Template_Loader' ) ) {
	 ...
	 * @author  Gary Jones
	 */
	class Shortcode_BP_Template_Loader {
		/**
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'shortcodes/templates';
